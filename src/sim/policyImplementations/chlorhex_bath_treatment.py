...
class ChlorhexBathTreatmentPolicy(BaseTreatmentPolicy):
    ...
    def prescribe(self, ward, patientId, patientDiagnosis, patientTreatment, modifierDct,
                  timeNow=None):
        """
        This returns a tuple of form (careTier, patientTreatment).
        modifierDct is for functional modifiers, like pyrheabase.TierUpdateModKey.FORCE_MOVE:True,
