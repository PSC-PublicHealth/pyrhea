...
def drawMap(geoDataPathList, stateFIPSRE, countyFIPSRE, countySet):
...
def main():
    ...
    geoDataPathList = [
#                        os.path.join(geoDataDir, 'IL/tigr_2010_17.geojson'),
...
#     countyCode = '059'
    ...
    drawMap(geoDataPathList, stateFIPSRE, countyFIPSRE, countySet)
