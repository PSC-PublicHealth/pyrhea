...
with open('../../models/OrangeCounty/transitmatrix.csv', 'rU') as f:
    keys, recs = csv_tools.parseCSV(f)

facKeys, facRecs = yaml_tools.parse_all('../../models/OrangeCounty/facilityfactsCurrent')
...
with open('../../models/OrangeCounty/transitmatrix.yaml', 'w') as f:
